...
#define LEFT_0 GPIO_PIN_7			//左边第一个红外检测模块
#define LEFT_1 GPIO_PIN_6			//左边第二个红外检测模块
#define MIDDLE GPIO_PIN_5			//中间红外检测模块
#define RIGHT_1 GPIO_PIN_4		//右边第二个红外检测模块
#define RIGHT_0 GPIO_PIN_3		//右边第一个红外检测模块
...
/**
  * @brief  红外循迹模块返回值处理函数
  * @param  无
  * @retval 红外循迹模块返回值数组（识别到黑线了为0，没识别到黑线为1）
  */
